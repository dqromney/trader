...
public enum AppConfig {
    ...
    YAHOO_EOD_HEADER_CLOSE_CHANGE("Close Chg"),
    YAHOO_EOD_HEADER_CLOSE_PERCENT("Close %"),
    YAHOO_EOD_HEADER_VOLUME("Volume"),
    YAHOO_EOD_HEADER_VOLUME_CHANGE("Volume Chg"),
    YAHOO_EOD_HEADER_VOLUME_DIRECTION("Volume Dir"),
    YAHOO_EOD_HEADER_ADJ_CLOSE("Adj Close"),
    YAHOO_EOD_HEADER_RSI("RSI"),
    YAHOO_EOD_HEADER_RSI_CHANGE("RSI Chg"),
    YAHOO_EOD_HEADER_RSI_DIRECTION("RSI Dir"),
    YAHOO_EOD_HEADER_SMA("SMA"),
    YAHOO_EOD_HEADER_SMA_CHANGE("SMA Chg"),
    YAHOO_EOD_HEADER_SMA_DIRECTION("SMA Dir"),
    ;
